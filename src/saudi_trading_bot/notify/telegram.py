...
def format_signal(signal: Signal, sharia_source: str = "", sharia_period: str = "") -> str:
    icon = "🟢" if signal.state.value == "READY" else "🟡" if signal.state.value == "WATCH" else "⚪️"
    ...
    return (
        ...
        f"Trend {signal.trend_score:.0f} | Momentum {signal.momentum_score:.0f} | Swing {signal.swing_score:.0f}\n"
